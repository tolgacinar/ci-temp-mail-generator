...
class ImapClient
{
	...
	public function __construct($imapPath = null, $login = null, $password = null)
	{
		$this->ci = &get_instance();
		$this->mailbox = new PhpImap\Mailbox($this->ci->config->item("imap_url"), $this->ci->config->item("imap_user"), $this->ci->config->item("imap_password"));
	}
...
/* End of file ImapClient.php */
/* Location: ./application/libraries/ImapClient.php */
